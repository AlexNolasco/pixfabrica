"""Tests for std-cosmic-network-gl audio drive."""
...
from pixfabrica_std.background.cosmic_network_gl import CosmicNetworkGL, _precompute_beat_decay
...
def test_audio_histories_use_job_wide_range(tmp_path: Path) -> None:
    ...
    clip = CosmicNetworkGL(id="cn", bus_select="main", sensitivity=2.0)
...
def test_stem_analyzer_drums_has_visible_multi_band_swing(tmp_path: Path) -> None:
    ...
    clip = CosmicNetworkGL(id="cn", bus_select="main", sensitivity=2.5)
