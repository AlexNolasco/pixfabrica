"""Tests for std-eq-bars-gl bin grouping, shaping, and bus reactivity."""
...
from pixfabrica_std.audio.eq_bars_gl import (
    _HEADROOM,
    EqBarsGL,
    _bin_group_ranges,
    _mean_group,
...
def test_clip_type():
    assert EqBarsGL.clip_type == "std-eq-bars-gl"
...
def test_stem_analyzer_drums_has_dynamic_heights(tmp_path: Path) -> None:
    ...
    clip = EqBarsGL(id="eq", bus_select="main", sensitivity=2.5, smoothing=0.45)
