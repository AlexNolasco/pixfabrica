"""Tests for std-fuzzy-clouds-gl audio drive."""
...
from pixfabrica_std.background.fuzzy_clouds_gl import FuzzyCloudsGL, _precompute_beat_decay
...
def test_bass_history_uses_job_wide_range(tmp_path: Path) -> None:
    ...
    clip = FuzzyCloudsGL(id="fc", bus_select="main", sensitivity=2.0)
...
def test_stem_analyzer_drums_has_visible_bass_swing(tmp_path: Path) -> None:
    ...
    clip = FuzzyCloudsGL(id="fc", bus_select="main", sensitivity=2.5)
