"""Tests for std-heart-dance-gl audio drive."""
...
from pixfabrica_std.background.heart_dance_gl import HeartDanceGL, _precompute_beat_decay
...
def test_audio_histories_use_job_wide_range(tmp_path: Path) -> None:
    ...
    clip = HeartDanceGL(id="hd", bus_select="main", sensitivity=2.0)
...
def test_stem_analyzer_drums_has_visible_bass_high_amp_swing(tmp_path: Path) -> None:
    ...
    clip = HeartDanceGL(id="hd", bus_select="main", sensitivity=2.5)
